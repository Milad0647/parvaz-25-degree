...
const TIPS = [
  "مصرف بهینه با تنظیم کولر روی ۲۵ درجه شروع می‌شود",
  "از شکاف سبز ۲۵° عبور کن — مسیر مصرف درست",
  "به بخش‌های پرمصرف ترموستر برخورد نکن",
  "آیتم‌های سبز مصرف بهینه را داخل شکاف جمع کن",
];
